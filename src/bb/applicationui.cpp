...
ApplicationUI::ApplicationUI(XmppConnectivity *xmpp, Settings *settings, UpdateManager *updater, EmoticonParser *emoticon) :
        QObject()
{
    ...
    qml->documentContext()->setContextProperty("xmppConnectivity",xmpp);
    qml->documentContext()->setContextProperty("settings",settings);
    qml->documentContext()->setContextProperty("updater",updater);
    qml->documentContext()->setContextProperty("emoticon",emoticon);
